...
POWERLIST = {
    ...
    7: ["50% de descuento", "halfdesc", "Los precios de las tiendas bajarán a la mitad por un periodo de tiempo",
        _POWERID, "halfdesc", 6, 1, 50], \
    8: ["Congelar enemigos", "freeze", "Los enemigos no se moverán por un periodo de tiempo", _POWERID, "freeze", 5, 2,
        50], \
    9: ["Armas extra duras", "infweapon", "Las armas no sufrirán de daños por un periodo de tiempo", _POWERID,
        "infweapon", 4, 3, 50], \
