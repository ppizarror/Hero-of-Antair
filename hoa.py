...
class hoa:
            ...
            if CONFIGURATION_DATA[13]:  # Si las configuraciones no están desactivadas
                conf = pop(
                    [[lang(17), lang(217), lang(218), lang(219), lang(64), lang(273), lang(274), lang(275), lang(671), \
                     ...
                     CONFIGURATION_DATA[1], DATA_LANGS, LANG_END, CONFIGURATION_DATA[2], CONFIGURATION_DATA[3],
                ...
                if conf.sent:  # Se genera un nuevo archivo de configuraciones
                    ...
                    if CONFIGURATION_DATA[0] != conf.values[0]:  # Si cambió el idioma
                        ...
                        if CONFIGURATION_DATA[7] == "ON" and CONFIGURATION_DATA[8] != DEFAULT_LANG_CONTENT:
                            ...
                            if CONFIGURATION_DATA[8] == "es": CONFIGURATION_DATA[10] = False; CONFIGURATION_DATA[
                                9] = False
                        LANG = {}
                        loadLang(False)
                    ...
                    if tipo == "casco":
                        ...
                        if item is not None:
                            ...
                            k = pop([[lang(34), lang(243), lang(242), lang(173), lang(248)],
                                     ...
                                     "itemInfoArmor", POP_XSIZE, POP_YSIZE, translate(putStrict(item.getName())),
                                     "armadura", translate(putStrict(item.getDescription())),
                        ...
                        if item is not None:
                            ...
                            k = pop([[lang(35), lang(241), lang(242), lang(173), lang(248), lang(267), lang(266)], \
                                     ...
                                     POP_YSIZE, \
                                     translate(putStrict(item.getName())), "armawb",
                            ...
                            if k.sent:  # Si se envía un evento
                                ...
                                if action == "drop":
                                    ...
                                    if self.player.getActiveBullet() is not None: self.player.addObject(
                                        self.player.getActiveBullet()); self.player.delActiveBullet()
                                    self.dibujarMundo()
                            del k
                    elif tipo == "chaleco":
                        ...
                        if item is not None:
                            ...
                            k = pop([[lang(37), lang(241), lang(242), lang(173), lang(248)],
                                     DATA_ICONS_ITEMS + item.getImage() + "_16.ico", \
                                     "itemInfoArmor", POP_XSIZE, POP_YSIZE, translate(putStrict(item.getName())),
                                     "arma", translate(putStrict(item.getDescription())), \
                        ...
                        if CONFIGURATION_DATA[15]:  # Si está activa la opción
                            ...
                            if "armor" in tipo:
                                ...
                                k = pop([[lang(33), lang(243), lang(242), lang(173), lang(248)],
                                         DATA_ICONS_ITEMS + item.getImage() + "_16.ico", \
                                         "itemInfo", POP_XSIZE, POP_YSIZE, translate(putStrict(item.getName())),
                                         "armadura", translate(putStrict(item.getDescription())), \
                                         item.getDefense(), item.getUsos()])
                            elif "bullet" in tipo:
                                self.sfx(24)
                                k = pop([[lang(33), lang(241), lang(244), lang(173), lang(248)],
                                         DATA_ICONS_ITEMS + item.getImage() + "_16.ico", \
                                         "itemInfo", POP_XSIZE, POP_YSIZE, translate(putStrict(item.getName())),
                                         "bullet", translate(putStrict(item.getDescription())), \
                                         item.getDamage(), item.getUsos()])
                            elif "coin" in tipo:
                                self.sfx(5)
                                k = pop([[lang(33), lang(244), "", lang(173), lang(248)],
                                         DATA_ICONS_ITEMS + item.getImage() + "_16.ico", \
                                         "itemInfo", POP_XSIZE, POP_YSIZE, translate(putStrict(item.getName())), "coin",
                                         translate(putStrict(item.getDescription())), \
                                ...
                                k = pop([[lang(33), lang(23) + " ", lang(244), lang(173), lang(248)],
                                         DATA_ICONS_ITEMS + item.getImage() + "_16.ico", \
                                         "itemInfo", POP_XSIZE, POP_YSIZE, translate(putStrict(item.getName())), "mana",
                                         translate(putStrict(item.getDescription())), \
                                ...
                                k = pop([[lang(33), lang(245), lang(246), lang(173), lang(248)],
                                         DATA_ICONS_ITEMS + item.getImage() + "_16.ico", \
                                         "itemInfo", POP_XSIZE, POP_YSIZE, translate(putStrict(item.getName())),
                                         "objeto", translate(putStrict(item.getDescription())), \
                                ...
                                k = pop([[lang(33), lang(247), lang(244), lang(173), lang(248)],
                                         DATA_ICONS_ITEMS + item.getImage() + "_16.ico", \
                                         "itemInfo", POP_XSIZE, POP_YSIZE, translate(putStrict(item.getName())),
                                         "pocion", translate(putStrict(item.getDescription())), \
                                         item.getPDV(), item.getUsos()])
                            elif "read" in tipo:
                                self.sfx(27)
                                k = pop([[lang(33), "", "", lang(173), lang(248)],
                                         DATA_ICONS_ITEMS + item.getImage() + "_16.ico", "itemInfo", \
                                         POP_XSIZE, POP_YSIZE, translate(putStrict(item.getName())), "libro",
                                         translate(putStrict(item.getDescription()))])
                            elif "weapon" in tipo:
                                if isIn(item.getImage(), ARROW_WEAPONS_PREFIX):
                                ...
                                k = pop([[lang(33), lang(241), lang(242), lang(173), lang(248)],
                                         DATA_ICONS_ITEMS + item.getImage() + "_16.ico", \
                                         "itemInfo", POP_XSIZE, POP_YSIZE, translate(putStrict(item.getName())), "arma",
                                         translate(putStrict(item.getDescription())), \
                                         item.getDamage(), item.getUsos()])
                            try:
                                k.w.mainloop(1)
                                if k.sent:  # Si se envía un evento
                                    ...
                                    if action == "drop":
                                        ...
                                        if i > 0: self.player.setItem(i,
                                                                      self.player.getItem(i - 1)); self.player.setItem(
                                            i - 1, item)
                                    elif action == "right":
                                        if i < (self.player.getItemAmount() - 1): self.player.setItem(i,
                                                                                                      self.player.getItem(
                                                                                                          i + 1)); self.player.setItem(
                                            i + 1, item)
                                    elif action == "super_left":
                                        if self.player.getItemAmount() > 2: self.player.setItem(i, self.player.getItem(
                                            0)); self.player.setItem(0, item)
                        ...
                        if typeClick == 0:  # Click derecho
                            ...
                            if CONFIGURATION_DATA[16]:  # Si está activa la opción
                                k = pop([[lang(380), lang(381), lang(382), lang(383), lang(173), lang(384)],
                                         ...
                                         "powerInfo", 163, 270, translate(poder.getName()),
                                         translate(poder.getDescripcion()), poder.getNivel(), \
        ...
        def _showPlayerInfo(e=None):
            ...
            if self.ingame:  # Si se encuentra en una partida
                ...
                e = pop([[lang(323), lang(245).replace(":", ""), lang(228), lang(173), lang(22).replace(":", ""),
                         ...
                         self.images.image("user_icon"), "show_info_player", _sizey, _sizex, self.player.getName(),
                         translate(self.player.getType()), self.player.getEdad(), \
                         translate(self.player.getInfo()), self.player.getLife(), self.player.getMaxLife(),
    ...
    def checkItems(self):
        ...
        if self.player.getLeftWeapon() is not None:
            if self.player.getLeftWeapon().estaDestruido():
                ...
                if self.player.getActiveBullet() is not None:
                    if self.player.getActiveBullet().estaDestruido(): self.player.delActiveBullet(); self.static.addDroppedWeapon(); self.setInfo(
                        lang(276))
        if self.player.getRightWeapon() is not None:
    ...
    def combateGrupal(self, event=None, event2=None, breakpoint=None):
        ...
        def _lookAvaiablePos(posx, posy, movements, turn, tipo, ataque):
                ...
                if 0 <= newposx < self.board.getBoardSizeX() and 0 <= newposy < self.board.getBoardSizeY():  # Si se está dentro de los márgenes
                    if self.board.getLogic(newposx, newposy) == "none":  # Si es un tile válido continua
                        ...
                        if tipo == "PL":
                            ...
                            flecha = self.world.create_image(25 + 32 * newposx + self.board.getBoardCorreccionX(),
                                                             self.board.getBoardCorreccionY() + 32 * newposy + 25, \
                                                             image=self.images.image(self.board.getWeapon()),
                                                             tags=texture_tile)
                        avaiablepos.append([newposx, newposy])
                        tags.append(tag_tile)
                    ...
                    if self.player.getLeftWeapon() is not None:  # Si posee un arma izquierda
                        if self.player.getActiveBullet() is not None:  # Si tiene balas
                            if self.player.getLeftWeapon().getType() == "weapon/left":  # Si son flechas
                                if self.nivel_dificultad == DIFICULTAD_DIFICIL:
                                    direcciones = [0, 1, 0, 1, 1, 0, 1, 0]  # NE,N,NW,W,E,SE,S,SW
                                else:
            ...
            for c in range(1, movements + 1):  # Se buscan las posiciones válidas para el ataque con flecha
                ...
                if direcciones[1] == 1: _lookArrow(posx, posy - c, direcciones, 1, avaiable_attack,
                                                   image_avaiable_tiles_arrow, tipo)  # se busca al norte
                if direcciones[2] == 1: _lookArrow(posx + c, posy - c, direcciones, 2, avaiable_attack,
                                                   image_avaiable_tiles_arrow, tipo)  # se busca al nor-oeste
                if direcciones[3] == 1: _lookArrow(posx - c, posy, direcciones, 3, avaiable_attack,
                                                   image_avaiable_tiles_arrow, tipo)  # se busca al este
                if direcciones[4] == 1: _lookArrow(posx + c, posy, direcciones, 4, avaiable_attack,
                                                   image_avaiable_tiles_arrow, tipo)  # se busca al oeste
                if direcciones[5] == 1: _lookArrow(posx - c, posy + c, direcciones, 5, avaiable_attack,
                                                   image_avaiable_tiles_arrow, tipo)  # se busca al sur-este
                if direcciones[6] == 1: _lookArrow(posx, posy + c, direcciones, 6, avaiable_attack,
                                                   image_avaiable_tiles_arrow, tipo)  # se busca al sur
                if direcciones[7] == 1: _lookArrow(posx + c, posy + c, direcciones, 7, avaiable_attack,
            ...
            if tipo == "FS":
                if self.nivel_dificultad in [DIFICULTAD_FACIL, DIFICULTAD_MEDIO]:
                    direcciones = [1, 1, 0, 0, 1, 0, 1, 1]  # NE,N,NW,W,E,SE,S,SW
                else:
                    direcciones = [0, 1, 0, 0, 1, 0, 1, 0]  # NE,N,NW,W,E,SE,S,SW
            ...
            for c in range(1, movements + 1):  # Se buscan las posiciones válidas
                if direcciones[0] == 1: _look(posx - c, posy - c, direcciones, 0, avaiable_pos,
                                              image_avaiable_tiles_tags)  # se busca al nor-este
                if direcciones[1] == 1: _look(posx, posy - c, direcciones, 1, avaiable_pos,
                                              image_avaiable_tiles_tags)  # se busca al norte
                if direcciones[2] == 1: _look(posx + c, posy - c, direcciones, 2, avaiable_pos,
                                              image_avaiable_tiles_tags)  # se busca al nor-oeste
                if direcciones[3] == 1: _look(posx - c, posy, direcciones, 3, avaiable_pos,
                                              image_avaiable_tiles_tags)  # se busca al este
                if direcciones[4] == 1: _look(posx + c, posy, direcciones, 4, avaiable_pos,
                                              image_avaiable_tiles_tags)  # se busca al oeste
                if direcciones[5] == 1: _look(posx - c, posy + c, direcciones, 5, avaiable_pos,
                                              image_avaiable_tiles_tags)  # se busca al sur-este
                if direcciones[6] == 1: _look(posx, posy + c, direcciones, 6, avaiable_pos,
                                              image_avaiable_tiles_tags)  # se busca al sur
                if direcciones[7] == 1: _look(posx + c, posy + c, direcciones, 7, avaiable_pos,
        ...
        def _move(x, y, id, type):
            ...
            if type == "PL":
                tag = ["grupal:follower:actor:" + str(id), "grupal:player:box", "grupal:player:number", 22]
            elif type == "MB":
                tag = ["grupal:mob:actor:" + str(id), "grupal:mob:box:" + str(id), "grupal:mob:number:" + str(id), 25]
            else:
        ...
        def _fight(group, mobs, player, x, y, mob_id, mode):
            ...
            if mobs.getType() != "PL":  # Si el defensor no es el jugador
                ...
                if atk > dff:
                    kills = int((atk - dff) / vida_unitaria)  # cantidad de muertos
                else:
                    kills = 0
            else:
            ...
            if player:
                self.setInfo(lang(727, str(atk), str(dff)))  # si el jugador tomo el rol del atacante
            else:
                if mobs.getType() == "PL":
                    self.setInfo(lang(734, str(atk), str(dff * group.getCant())))
                else:
            ...
            if (
                ...
                if group.getType() == "FL" and mode == "f":
                    ...
                    self.sfx(13)  # sonidos
                if player:
                    self.setInfo(lang(728, str(kills)))  # si no se han matado a todos
                else:
                    if mobs.getType() != "PL":
                        self.setInfo(lang(735, str(kills)))  # si no se han matado a todos
                    else:
                        if kills == cant_tot:
                ...
                if mobs.getType() != "PL":
                    mobs.disminuir(kills)  # se disminuye la cantidad de elementos en el grupo
                else:
                    mobs.setVida(kills)
                if player:
                    ...
                    if mobs.getType() != "PL":
                        ...
                        self.world.create_text(22 + 32 * x + self.board.getBoardCorreccionX(),
                                               ...
                                               font=self.fonts[1], anchor=CENTER, \
                        ...
                        if [x,
                            ...
                            if self.board.getLogic(x, y) == "none":  # Si no hay nada en el tile clickeado se mueve
                                ...
                                if yi == y:  # Si está en el mismo y
                                    ...
                                    to = [x - 1, y - 1]  # si está en la esquina inferior izquierda
                                elif yi > y and xi < x:
                                    to = [x - 1, y + 1]  # si está en la esquina superior izquierda
                                elif yi < y and xi > x:
                                    to = [x + 1, y - 1]  # si está en la esquina inferior derecha
                                elif yi > y and xi > x:
                                    to = [x + 1, y + 1]  # si está en la esquina superior derecha
                                ...
                                for mobs in self.board.getEnemies():  # Se recoge al mob a atacar
                                    if mobs.getPosX() == x and mobs.getPosY() == y:  # Se recoge al grupo seleccionado
                                        ...
                                        if abs(x - to[0]) <= 1 and abs(y - to[
                                            1]) <= 1 and self.nivel_dificultad != DIFICULTAD_FACIL: near = True
                    ...
                    if mob.getTipoCombate() == MODE_FIGHT_NORMAL:  # Si es un mob normal
                        ...
                        if mob.isDead():  # Si el mob murio
                            ...
                            if self.maplightning[y][x] == 0:
                                self.mapItemsTextures[y][x] = choice(EFFECT_BLOOD_DAY)
                            else:
                                self.mapItemsTextures[y][x] = choice(EFFECT_BLOOD_NIGHT)
        ...
        def _throwArrow(x, y):
            ...
            if (self.player.getActiveBullet() is not None) and MOVEMENT_ANIMATION[
                ...
                flecha = self.world.create_image(26 + 32 * self.playerPos[0] + self.canvasCorrecion[1],
                                                 self.canvasCorrecion[0] + 32 * self.playerPos[1] + 26, \
                                                 image=self.images.image(
                    ...
                    if self.canmove:  # Si ha pasado el tiempo minimo para el ataque
                        ...
                        if not self.enemy.isDead():  # Si el enemigo no muere ataca
                            ...
                            if ataque[0] - ataque[1] > 0:
                                self.playerText("-" + str(ataque[0] - ataque[1]), "rojo", False)
                            else:
                ...
                if comando == "GIVE" and self.player.isEditor():
                        ...
                        if action == "XY":
                            ...
                            if pos[0].isdigit() and pos[1].isdigit():  # Si el id es numérico
                                ...
                                if 0 <= y < self.mapSize[1] and 0 <= x < self.mapSize[
                                    ...
                                    self.error(lang(117))  # si las coordenadas no son correctas
                            else:
                                self.error(lang(107))  # Si los datos no son numéricos
                        elif action == "MAP":
                        ...
                        if data.isdigit():  # Si el data es numérico
                            ...
                            if action == "DAMAGE" or action == "PLAYER.DAMAGE":
                                ...
                                if 0 < int(data) < 13:  # Si el nivel es válido
                                    ...
                                    self.error(lang(185))  # si el nivel no está entre 1 y 12
                                self.dibujarPowers()
                                self.dibujarMundo()
                                ...
                                if l != self.player.getLevel():
                                    if l - self.player.getLevel() < 0:
                                        self.setInfo(lang(193, str(self.player.getLevel() - l)))
                                    else:
                                        self.setInfo(lang(194, str(l - self.player.getLevel())))
                    ...
                    try:
                        ...
                        if ".save" in action:
                            ...
                            if "." not in action:
                                ...
                                self.error(lang(771), 70)  # el nombre de la partida no es válido
                    except:
                        self.loadGame()
                elif comando == "MUTE":
                    self.stopSound()
                    ...
                    if self.ingame:
                        ...
                        if action == "ITEMS":
                            try:
                                ...
                                self.error(lang(766), 70)  # ocurrió un error al cargar los mapas
                        elif action == "POWERS":
                            try:
                                for power in POWERLIST.keys()[::-1]: self.setInfo(
                                    "  SHORT:" + POWERLIST[power][1] + " " + POWERLIST[power][0], False)
                                self.setInfo(lang(769))
                            except:
                                self.error(lang(768), 70)  # ocurrió un error al cargar la lista de poderes
                        elif action == "MAPS":
                            try:
                                ...
                                self.error(lang(765), 70)  # ocurrió un error al cargar los mapas
                        else:
                            self.error(lang(108))
                    else:
                        ...
                        if not self.multiplayer_isconected:
                            if not self.inBattle:
                                if not self.inNpc:
                                    ...
                                    self.error(lang(819), 82)  # si no se encuentra interactuando con un npc
                            else:
                                self.error(lang(818), 82)  # si no se encuentra combatiendo
                        else:
                            self.error(lang(802), 70)  # si no se encuentra jugando
                    else:
                        self.error(lang(109), 70)  # si no se encuentra jugando
                    ...
                    if self.ingame:
                        if self.multiplayer_isconected:
                            ...
                            self.error(lang(801), 70)  # si no se encuentra conectado
                    else:
                        self.error(lang(109), 70)  # si no se encuentra jugando
                elif comando == "TOP":
                    if self.ingame:
    ...
    def dibujarArmor(self):
        ...
        item = self.player.getCasco()
        if item is not None: self.infoArmaduraCasco.config(image=self.images.image(item.getImage() + "_32"),
                                                           state=NORMAL, cursor="hand2")
        item = self.player.getLeftWeapon()
        if item is not None: self.infoArmaduraArmaIzquierda.config(image=self.images.image(item.getImage() + "_32"),
                                                                   state=NORMAL, cursor="hand2")
        item = self.player.getChaleco()
        if item is not None: self.infoArmaduraChaleco.config(image=self.images.image(item.getImage() + "_32"),
                                                             state=NORMAL, cursor="hand2")
        item = self.player.getRightWeapon()
        if item is not None: self.infoArmaduraArmaDerecha.config(image=self.images.image(item.getImage() + "_32"),
                                                                 state=NORMAL, cursor="hand2")
        item = self.player.getPantalones()
        if item is not None: self.infoArmaduraPantalones.config(image=self.images.image(item.getImage() + "_32"),
                                                                state=NORMAL, cursor="hand2")
        item = self.player.getBotas()
        ...
        if j != 0:  # Si el jugador tiene items
            ...
            while True:
                ...
                if k == 0 and self.itemnumberlist > 0:  # Si es el primer elemento se linkea la hoja anterior
                    ...
                    if self.itemnumberlist > 0:
                        item = self.player.getItem(k + self.itemnumberlist - 1)  # si ya hay mas de una pagina
                    else:
                        item = self.player.getItem(k + self.itemnumberlist)  # si sólo es una pagina de items
                    try:
        ...
        if not (self.inBattle and (self.tipoCombate == MODE_FIGHT_GROUP or self.tipoCombate == MODE_FIGHT_LINEAL)):
            ...
            for blood in self.board.getBlood():
                self.world.create_image(18 + 32 * blood[0] + self.board.getBoardCorreccionX(),
                                        18 + 32 * blood[1] + self.board.getBoardCorreccionY(), \
            ...
            for k in range(self.board.getBoardSizeY()):
                for j in range(self.board.getBoardSizeX()):
                    self.world.create_image(18 + self.board.getBoardCorreccionX() + 32 * j,
                                            ...
                                            image=self.images.image(self.board.getItemTexture(j, k)),
        ...
        if self.ingame:  # Si se encuentra jugando una partida
            if e == "automatic_bullet":  # Si bullet se escoge automaticamente
                ...
                for bullet in self.player.getItems():  # Si el item es una bala se agrega
                    if bullet.getType() == "bullet": armamento.append(
                ...
                if (amir(archivo.replace(".save", ".sav")).strip() == key1[0] and amir(
                    ...
                    if len(self.mobs) != 0:  # Si hay mobs en el mapa que se cargó
                        try:  # Se cargan los mob
                            ...
                            try:
                                self.root.after_cancel(self.lastmovementId)  # se elimina el ultimo movimiento
                            except:
                                totalerrors += 1
                                ...
                                for elem in loadmapnpc:  # Se recorren los npc
                                    ...
                                    self.npc.append(
                                        npc(elem[0], elem[1], elem[2], elem[3], elem[4], elem[5], int(elem[6]), elem[7], \
                                            int(elem[8]), elem[9], int(elem[10]), int(elem[11]), elem[12],
                                            int(elem[13]), \
                    ...
                    try:  # Se cargan las quest
                        print lang(583),
                        for quest in range(1, len(loadquest) - 1): self.player.addQuest(
                    ...
                    try:  # Se cargan las estadísticas
                        ...
                        self.static.__init__(int(loadstatics[0]), int(loadstatics[1]), int(loadstatics[2]),
                                             int(loadstatics[3]), \
                                             int(loadstatics[4]), int(loadstatics[5]), int(loadstatics[6]),
                                             int(loadstatics[7]), \
                                             int(loadstatics[8]), int(loadstatics[9]), int(loadstatics[10]),
                                             int(loadstatics[11]), \
                                             int(loadstatics[12]), int(loadstatics[13]), int(loadstatics[14]),
                                             int(loadstatics[15]), \
                                             int(loadstatics[16]), int(loadstatics[17]), int(loadstatics[18]),
                                             int(loadstatics[19]))
                        print lang(310)
                    ...
                    try:  # Se cargan las balas y poderes
                        if load[18] != "%NULL%":
                            self.player.setActiveBullet(Item(parseObject(load[18])))  # armamento predefinido
                        else:
                            self.player.delActiveBullet()
                        if load[19] != "%NULL%":
                            ...
                            self.player.delFirstPower()
                        if load[20] != "%NULL%":
                            self.player.setSecondPower(load[20])  # segundo poder
                        else:
                            self.player.delSecondPower()
                    ...
                    try:  # Se cargan los items
                        ...
                        while True:  # Se carga mientras no salga #end# en el archivo
                            if load[30 + i] != "#end#":
                                ...
                                i += 1
                                if i == 100:
                                    self.root.after(1, _loadingScreen(self.images.image("loading4")))
                                elif i == 200:
                                    self.root.after(1, _loadingScreen(self.images.image("loading5")))
                            else:
                                break
                        print lang(310)
        ...
        try:
            ...
            if self.maplightning[self.playerPos[1]][self.playerPos[0]] != self.maplightning[y][
                ...
                if self.maplightning[y][x] == 0:  # Modifico la iluminación de la textura
                    ...
                    self.world.itemconfig("player", image=self.images.image(self.player.getLinkImage() + "_1"))
                ...
                if 0 <= y < self.mapSize[1] and 0 <= x < self.mapSize[0]:  # Si las coordenadas estan dentro del mapa
                    if self.mapLogic[y][x] == "none":  # Si el lugar esta vacío
                        if self.maplightning[mob.getPosicionY()][mob.getPosicionX()] != self.maplightning[y][
                            ...
                            if self.maplightning[y][x] == 0:
                                self.world.itemconfig("mob:" + str(i_d), image=self.images.image(mob.getImage() + "_0"))
                            else:
                                self.world.itemconfig("mob:" + str(i_d), image=self.images.image(mob.getImage() + "_1"))
                        ...
                        try:  # Se mueve la textura del npc
                            if not MOVEMENT_ANIMATION[0]:  # Movimiento sin animación
                                self.world.coords("npc:" + str(i_d),
                                                  18 + 32 * np.getPosicionX() + self.canvasCorrecion[1], \
            ...
            if x != self.playerPos[0] or y != self.playerPos[
                ...
                if logic in AVAIABLE_WALK:  # Si no hay nada en el bloque que sigue
                    ...
                    if self.nivel_dificultad in [DIFICULTAD_FACIL,
                        ...
                        self.setInfo(lang(choice([301, 302, 303])))  # mensaje al usuario (de que no subio nada)
            ...
            if not self.inBattle:
                if not self.inNpc:
                    if not self.multiplayer_isconected:  # Si no está conectado a un servidor
                        ...
                        self.error(lang(770), 70)  # ya se encuentra conectado a un servidor
                else:
                    self.error(lang(819), 82)  # se encuentra interactuando con un npc
            else:
                    ...
                    if adv:  # Si termina el diálogo con el npc
                        if (
                            ...
                            if self.currentNpc.isFade():
                                ...
                                self.currentNpc.end()
                                self.root.after(SHOWMESSAGESTIME / 2, _setnonpc)
                                if "{setquest" in self.currentNpc.getStrings(): self.root.after(SHOWMESSAGESTIME / 2,
                                                                                                _delnpc)
                            self.currentNpc = None
                        else:
                            self.currentNpc.addCount()
                ...
                if bold:
                    if player:
                        ...
                        msgid = self.world.create_text(self.enemy.getPosicionX() * 32 + self.canvasCorrecion[1] + 22, \
                                                       self.enemy.getPosicionY() * 32 + self.canvasCorrecion[0] + 3,
                    ...
                    if msg.replace("+", "").replace("-", "").isdigit():
                        ...
                        self.root.after(PLAYER_TEXT_TIME * 3, lambda: self.world.delete(msgid))
                else:
                    if player:
                        msgid = self.world.create_text(self.playerPos[0] * 32 + self.canvasCorrecion[1] + 22, \
                                                       self.playerPos[1] * 32 + self.canvasCorrecion[0] + 3, text=msg,
            ...
            if not self.inBattle and not self.inNpc:  # Si no se encuentra peleando ni interactuando con un npc
                ...
                if len(nameSav) > 0 and continuar:  # Si está todo listo
                    ...
                    try:  # Información del jugador
                        ...
                        if self.player.getActiveBullet() is not None:
                            archivo.write(str(self.player.getActiveBullet().export()))
                        else:
                            archivo.write("%NULL%\n")
                        if self.player.getFirstPower() is not None:
                            archivo.write(str(self.player.getFirstPower()) + "\n")
                        else:
                            archivo.write("%NULL%\n")
                        if self.player.getSecondPower() is not None:
                            archivo.write(str(self.player.getSecondPower()) + "\n")
                        else:
                            archivo.write("%NULL%\n")
                        print lang(310)
                    ...
                    try:  # Información de las armas
                        ...
                        try:
                            archivo.write(self.player.getLeftWeapon().export().decode('utf-8'))
                        except:
                            archivo.write("%NULL%\n")
                        try:
                            archivo.write(self.player.getRightWeapon().export().decode('utf-8'))
                        except:
                            archivo.write("%NULL%\n")
                        print lang(310)
                    ...
                    try:  # Información de la armadura
                        ...
                        archivo.write("#armor#\n")
                        try:
                            archivo.write(self.player.getCasco().export().decode('utf-8'))
                        except:
                            archivo.write("%NULL%\n")
                        try:
                            archivo.write(self.player.getChaleco().export().decode('utf-8'))
                        except:
                            archivo.write("%NULL%\n")
                        try:
                            archivo.write(self.player.getPantalones().export().decode('utf-8'))
                        except:
                            archivo.write("%NULL%\n")
                        try:
                            archivo.write(self.player.getBotas().export().decode('utf-8'))
                        except:
                            archivo.write("%NULL%\n")
                        print lang(310)
    ...
    def setCombat(self, mob, i_d):
        ...
        if self.tipoCombate == MODE_FIGHT_NORMAL or self.player.getTotalFriends() == 0:  # Si es un combate normal o no se tienen amigos para luchar
            ...
            try:  # Si el mob posee un sonido caracteristico se le reproduce
                if self.enemy.getSound() != "%NOSOUND%": self.sonidoFx(
            ...
            self.board = board(self.player, self.enemy, self.mapTextures[self.playerPos[1]][self.playerPos[0]], \
                               self.mapTextures[self.enemy.getPosicionY()][self.enemy.getPosicionX()],
                               choice(TEXTURE_OBSTACLES), \
                               self.maplightning[self.playerPos[1]][self.playerPos[0]],
                               self.maplightning[self.enemy.getPosicionY()][self.enemy.getPosicionX()], \
                               self.nivel_dificultad, self.dificultad[7], self.images,
                               self.mapSound[self.playerPos[1]][self.playerPos[0]], \
                               self.mapSound[self.enemy.getPosicionY()][self.enemy.getPosicionX()],
            ...
            self.setInfo(lang(725, str(int(self.enemy.getLife() * (2 - self.dificultad[7]) * 0.12)),
                              str(int(self.enemy.getAtaque() * (2 - self.dificultad[7]) * 0.4)), \
    ...
    def setDificultad(self):
        ...
        if self.nivel_dificultad == DIFICULTAD_FACIL:
            ...
            self.dificultad = [0, 0, 0, 0, 0, int(TIME_MOVE_MOBS_NORMAL * 1), 0, 1]
    ...
    def setWorld(self):
        ...
        try:
                ...
                for j in range(self.mapSize[0]):
                    ...
                    if logic == 1:  # Jugador
                        ...
                        self.mobs.append(mob(int(prop[0]), int(prop[1]), textureMobAnalysis(int(prop[2])), \
                                             ...
                                             int(prop[8]), int(prop[9]), int(prop[10]), prop[11], prop[12], prop[13],
                                             int(prop[14]), \
                        ...
                        log = "moveto," + item[2]  # Moverse a un (x,y) determinado
                    elif logic == 20:
                        log = "nopass"  # No pasar
                    elif logic == 21:
                        log = "pass"  # Pasar
                        ...
                        log = "movefrom," + item[2]  # Moverse desde (no hace nada)
                    elif logic == 26:
                        log = "bed"  # Cama
                    elif logic == 27:
                        ...
                        self.npc.append(npc(prop[0], textureMobAnalysis(int(prop[1])), prop[2], prop[3], prop[4], \
                                            prop[5], int(prop[6]), prop[7], int(prop[8]), prop[9], j, k, "FALSE", 0, j,
                                            k, prop[10]))
                    elif logic == 44:
                        log = "alfombra"
                    else:
            ...
            if CANVAS_MAX_SIZE[0] > self.mapSize[1]:
                self.canvasCorrecion[0] = (CANVAS_MAX_SIZE[0] - self.mapSize[1]) * 16  # Horizontal
            else:
                self.canvasCorrecion[0] = 0
            ...
            try:
                if self.playerPos[0] <= self.mapSize[1] / 2:
                    bloq = self.world.create_rectangle(self.playerPos[0] * 32 + self.canvasCorrecion[1] + 37,
                                                       self.playerPos[1] * 32 + self.canvasCorrecion[0] - height, \
                    ...
                    msg = self.world.create_text(self.playerPos[0] * 32 + self.canvasCorrecion[1],
                                                 self.playerPos[1] * 32 + self.canvasCorrecion[0] + 3 - height + corr, \
